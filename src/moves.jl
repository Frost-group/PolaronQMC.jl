...
function Single!(path::Path, particle::Int, potentials::Potential, regime::Regime)
    ...
    old_action = 
		...
		potential_action(path, bead, particle, potentials, regime)	# Potential at bead for all particles incl. any const., 1-body or 2-body interactions.
