...
#Experimental multi threaded PIMC 
function PIMCX(n_steps::Int, equilibrium_skip, observable_skip, path::Path, movers::Array, observables, estimators::Array, potential::Potential, regime::Regime; adjust = true, visual = false)
	#setting up storage of output
